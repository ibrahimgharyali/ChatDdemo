...
import com.example.ibrahim.chatddemo.interfaces.InternetConnection;
...
public class NetworkUtils {
    ...
    public static void checkInternet(@NonNull final Context context, @NonNull final InternetConnection internetConnection) {
        if (isConnected(context)) {
            internetConnection.onAvailable();
        } else {
            ErrorUtils.showInternetErrorToast(context);
        }
    }
